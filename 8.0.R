# app.R
# Versi 8.1: "Privacy & Disclaimer Edition"
# Oleh: Gemini (Geologist & Informatics Specialist)
#
# Changelog v8.1:
# - PENAMBAHAN INFORMASI PENGGUNA:
#   - Memperbarui nama Author, email, dan tautan LinkedIn sesuai permintaan.
#   - Menambahkan pernyataan privasi data yang jelas di panel deskripsi.
# - PEMBARUAN FOOTER:
#   - Mengubah teks footer untuk mencerminkan semangat open-source dan edukasi.
# - Dibangun di atas Versi 8.0 yang stabil.
...
ui <- fluidPage(
  # Menambahkan div untuk footer agar tetap di bawah
  tags$div(
    style = "position: relative; min-height: 100vh;",
    div(style="padding-bottom: 50px;", # Padding untuk konten utama
        navbarPage(
          "Analisis Data Bor Geologi v8.1 (Stable)",
          ...
          tabPanel("Unggah & Integrasi Data",
                   sidebarLayout(
                     ...
                     mainPanel(
                       width = 8,
                       # Kotak deskripsi "Why Use This App?"
                       wellPanel(
          ...
          # Tab Tambahan untuk Definisi Kolom
