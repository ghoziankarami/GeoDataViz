...
-   **`web-version` (Live Demo):** This branch contains the code deployed to the public Shinyapps.io server. It has the **Save & Load Session** feature removed for simplicity and security in a multi-user web environment. GO to this link to launch the webapp: [GeodataViz Web App](https://ghoziankarami.shinyapps.io/GeodataViz/)
